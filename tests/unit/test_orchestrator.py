...
class TestScannerOrchestrator:
    ...
    def test_strategy_selection_logic(self, orch):
        ...
        assert isinstance(orch._get_strategy("amazon"), AmazonScanner) # Test de la casse
    ...
    def test_run_link_discovery_success(self, orch):
        ...
        orch.db.update_product_merchant_url.assert_called_once_with(10, 'https://www.amazon.fr/dp/B000XYZ')
    ...
    def test_run_stock_monitoring_handles_404(self, orch):
        ...
        orch.db.get_products_to_monitor.return_value = [
            {'produit_id': 1, 'url_marchand_finale': 'http://amazon.fr/p1', 'nom_vendeur': 'amazon'}
        ]
        
        orch.http.fetch.return_value = {
            'html': '', 'status_code': 404, 'url_finale': 'http://amazon.fr/p1', 'error': None
        }
