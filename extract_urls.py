...
def sync_sitemap_to_db():
    ...
    try:
        with httpx.Client(timeout=30.0) as client:
            ...
            # On ne garde que ce qui contient '/produit/' pour ignorer les images
            # et autres bruits
            ...
            logger.info(
                f"{len(product_urls)} produits réels identifiés "
                f"sur {len(all_locs)} entrées au total."
            )
            ...
            logger.info(
                f"Synchronisation terminée : {new_count} "
